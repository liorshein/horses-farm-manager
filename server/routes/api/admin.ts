...
import {
    ...
    getLessonsPerMonth, getAllStudentsData, getAllInstructorsData, getStudentsData} from '../../controllers/adminController';
...
adminRouter.get('/lessons-per-month', verifyRoles(ROLES_LIST.Admin), getLessonsPerMonth)
